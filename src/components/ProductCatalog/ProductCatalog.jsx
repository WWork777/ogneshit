...
export default function ProductCatalog() {
  ...
  // Вычисляем общее количество страниц (групп)
  const totalPages = Math.ceil(products.length / itemsPerPage);

  // Вычисляем текущую страницу на основе activeIndex
  // Если достигли конца, устанавливаем последнюю страницу
  const currentPage = isEnd
    ? totalPages - 1
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Здесь мы представили основные типы конструкций,
            <br />
